...
function this:ctor(go,...)
    ...
    self._sprite_compare:SetSpriteByPath("UI/Common/Sprite/JT_P02")
...
function this:CountSizeDeltas()
    ...
    if(width)then
        ...
        self._contentTrans.sizeDelta = Vector2.New(width - self._text_label:GetPreferredWidth(),0)
        self._text_content:SetText(self._content)
        self._contentTrans.sizeDelta = Vector2.New(width - self._text_label:GetPreferredWidth(),self._text_content:GetPreferredHeight())
    else
        self._text_content:SetHorizontalWrapMode(HorizontalWrapMode.Overflow)
        self._contentTrans.sizeDelta = Vector2.New(self._text_content:GetPreferredWidth(),0)
        self._contentTrans.sizeDelta = Vector2.New(self._text_content:GetPreferredWidth(),self._text_content:GetPreferredHeight())
    end
