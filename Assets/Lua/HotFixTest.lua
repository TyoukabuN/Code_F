...
-- str_de = json.decode(str)


-- local onReturn = function(req)
--     print(req.downloadHandler.text)
--     printc(json.decode(req.downloadHandler.text).name)
--     printc(json.decode(req.downloadHandler.text).age)
--     printc(json.decode(req.downloadHandler.text).sex)
-- end
