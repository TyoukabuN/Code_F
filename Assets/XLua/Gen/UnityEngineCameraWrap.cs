...
namespace XLua.CSObjectWrap
{
    ...
    public class UnityEngineCameraWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			...
			Utils.BeginObjectRegister(type, L, translator, 0, 48, 55, 42);
		    ...
		    Utils.BeginClassRegister(type, L, __CreateInstance, 5, 7, 3);
		    ...
		    try {
                ...
                
                {
                    ...
                    float _duration = (float)LuaAPI.lua_tonumber(L, 3);
                        ...
                        DG.Tweening.Tweener gen_ret = gen_to_be_invoked.DOAspect( _endValue, _duration );
                        translator.Push(L, gen_ret);
		    ...
		    try {
                ...
                
                {
                    ...
                    float _duration = (float)LuaAPI.lua_tonumber(L, 3);
                        ...
                        DG.Tweening.Tweener gen_ret = gen_to_be_invoked.DOFarClipPlane( _endValue, _duration );
                        translator.Push(L, gen_ret);
		    ...
		    try {
                ...
                
                {
                    ...
                    float _duration = (float)LuaAPI.lua_tonumber(L, 3);
                        ...
                        DG.Tweening.Tweener gen_ret = gen_to_be_invoked.DOFieldOfView( _endValue, _duration );
                        translator.Push(L, gen_ret);
		    ...
		    try {
                ...
                
                {
                    ...
                    float _duration = (float)LuaAPI.lua_tonumber(L, 3);
                        ...
                        DG.Tweening.Tweener gen_ret = gen_to_be_invoked.DONearClipPlane( _endValue, _duration );
                        translator.Push(L, gen_ret);
		    ...
		    try {
                ...
                
                {
                    ...
                    float _duration = (float)LuaAPI.lua_tonumber(L, 3);
                        ...
                        DG.Tweening.Tweener gen_ret = gen_to_be_invoked.DOOrthoSize( _endValue, _duration );
                        translator.Push(L, gen_ret);
		    ...
		    try {
                ...
                
                {
                    ...
                    float _duration = (float)LuaAPI.lua_tonumber(L, 3);
                        ...
                        DG.Tweening.Tweener gen_ret = gen_to_be_invoked.DOPixelRect( _endValue, _duration );
                        translator.Push(L, gen_ret);
		    ...
		    try {
                ...
                
                {
                    ...
                    float _duration = (float)LuaAPI.lua_tonumber(L, 3);
                        ...
                        DG.Tweening.Tweener gen_ret = gen_to_be_invoked.DORect( _endValue, _duration );
                        translator.Push(L, gen_ret);
