...
namespace XLua.CSObjectWrap
{
    ...
    public class LuaSystemWrap 
    {
        public static void __Register(RealStatePtr L)
        {
            ...
            Utils.RegisterFunc(L, Utils.CLS_IDX, "InheritGlobal", _m_InheritGlobal_xlua_st_);
            Utils.RegisterFunc(L, Utils.CLS_IDX, "GetLuaEnv", _m_GetLuaEnv_xlua_st_);
            Utils.RegisterFunc(L, Utils.CLS_IDX, "NewTable", _m_NewTable_xlua_st_);
            Utils.RegisterFunc(L, Utils.CLS_IDX, "EnUpdate", _m_EnUpdate_xlua_st_);
            Utils.RegisterFunc(L, Utils.CLS_IDX, "DeUpdate", _m_DeUpdate_xlua_st_);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				if(LuaAPI.lua_gettop(L) == 1)
				{
					...
					LuaSystem gen_ret = new LuaSystem();
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _m_InheritGlobal_xlua_st_(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    ...
                    LuaSystem.InheritGlobal( _table );
        ...
        static int _m_GetLuaEnv_xlua_st_(RealStatePtr L)
        {
		    try {
                ...
                
                {
                        ...
                        XLua.LuaEnv gen_ret = LuaSystem.GetLuaEnv(  );
                        translator.Push(L, gen_ret);
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _m_EnUpdate_xlua_st_(RealStatePtr L)
        {
		    try {
                ...
                {
                    System.Action<XLua.LuaTable> _func = translator.GetDelegate<System.Action<XLua.LuaTable>>(L, 1);
                    XLua.LuaTable _hInstance = (XLua.LuaTable)translator.GetObject(L, 2, typeof(XLua.LuaTable));
                    
                    LuaSystem.EnUpdate( _func, _hInstance );
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _m_DeUpdate_xlua_st_(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    ...
                    LuaSystem.DeUpdate( _func, _hInstance );
