...
namespace XLua.CSObjectWrap
{
    ...
    public class UnityEngineRectTransformWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			...
			Utils.BeginObjectRegister(type, L, translator, 0, 13, 9, 8);
		    ...
		    try {
                ...
                if(gen_param_count == 4&& translator.Assignable<UnityEngine.Vector2>(L, 2)&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 3)&& LuaTypes.LUA_TBOOLEAN == LuaAPI.lua_type(L, 4)) 
                {
                    ...
                    bool _snapping = LuaAPI.lua_toboolean(L, 4);
                        ...
                        DG.Tweening.Tweener gen_ret = gen_to_be_invoked.DOAnchorPos( _endValue, _duration, _snapping );
                        translator.Push(L, gen_ret);
                ...
                if(gen_param_count == 3&& translator.Assignable<UnityEngine.Vector2>(L, 2)&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 3)) 
                {
                    ...
                    float _duration = (float)LuaAPI.lua_tonumber(L, 3);
                        ...
                        DG.Tweening.Tweener gen_ret = gen_to_be_invoked.DOAnchorPos( _endValue, _duration );
                        translator.Push(L, gen_ret);
		    ...
		    try {
                ...
                if(gen_param_count == 4&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 2)&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 3)&& LuaTypes.LUA_TBOOLEAN == LuaAPI.lua_type(L, 4)) 
                {
                    ...
                    bool _snapping = LuaAPI.lua_toboolean(L, 4);
                        ...
                        DG.Tweening.Tweener gen_ret = gen_to_be_invoked.DOAnchorPosX( _endValue, _duration, _snapping );
                        translator.Push(L, gen_ret);
                ...
                if(gen_param_count == 3&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 2)&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 3)) 
                {
                    ...
                    float _duration = (float)LuaAPI.lua_tonumber(L, 3);
                        ...
                        DG.Tweening.Tweener gen_ret = gen_to_be_invoked.DOAnchorPosX( _endValue, _duration );
                        translator.Push(L, gen_ret);
		    ...
		    try {
                ...
                if(gen_param_count == 4&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 2)&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 3)&& LuaTypes.LUA_TBOOLEAN == LuaAPI.lua_type(L, 4)) 
                {
                    ...
                    bool _snapping = LuaAPI.lua_toboolean(L, 4);
                        ...
                        DG.Tweening.Tweener gen_ret = gen_to_be_invoked.DOAnchorPosY( _endValue, _duration, _snapping );
                        translator.Push(L, gen_ret);
                ...
                if(gen_param_count == 3&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 2)&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 3)) 
                {
                    ...
                    float _duration = (float)LuaAPI.lua_tonumber(L, 3);
                        ...
                        DG.Tweening.Tweener gen_ret = gen_to_be_invoked.DOAnchorPosY( _endValue, _duration );
                        translator.Push(L, gen_ret);
		    ...
		    try {
                ...
                if(gen_param_count == 4&& translator.Assignable<UnityEngine.Vector3>(L, 2)&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 3)&& LuaTypes.LUA_TBOOLEAN == LuaAPI.lua_type(L, 4)) 
                {
                    ...
                    bool _snapping = LuaAPI.lua_toboolean(L, 4);
                        ...
                        DG.Tweening.Tweener gen_ret = gen_to_be_invoked.DOAnchorPos3D( _endValue, _duration, _snapping );
                        translator.Push(L, gen_ret);
                ...
                if(gen_param_count == 3&& translator.Assignable<UnityEngine.Vector3>(L, 2)&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 3)) 
                {
                    ...
                    float _duration = (float)LuaAPI.lua_tonumber(L, 3);
                        ...
                        DG.Tweening.Tweener gen_ret = gen_to_be_invoked.DOAnchorPos3D( _endValue, _duration );
                        translator.Push(L, gen_ret);
		    ...
		    try {
                ...
                if(gen_param_count == 4&& translator.Assignable<UnityEngine.Vector2>(L, 2)&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 3)&& LuaTypes.LUA_TBOOLEAN == LuaAPI.lua_type(L, 4)) 
                {
                    ...
                    bool _snapping = LuaAPI.lua_toboolean(L, 4);
                        ...
                        DG.Tweening.Tweener gen_ret = gen_to_be_invoked.DOSizeDelta( _endValue, _duration, _snapping );
                        translator.Push(L, gen_ret);
                ...
                if(gen_param_count == 3&& translator.Assignable<UnityEngine.Vector2>(L, 2)&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 3)) 
                {
                    ...
                    float _duration = (float)LuaAPI.lua_tonumber(L, 3);
                        ...
                        DG.Tweening.Tweener gen_ret = gen_to_be_invoked.DOSizeDelta( _endValue, _duration );
                        translator.Push(L, gen_ret);
