...
namespace XLua
{
    public partial class DelegateBridge : DelegateBridgeBase
    {
		...
		public void __Gen_Delegate_Imp0(UnityEngine.Object p0)
		{
		...
		public void __Gen_Delegate_Imp2(UnityEngine.Networking.UnityWebRequest p0)
		{
#if THREAD_SAFE || HOTFIX_ENABLE
            lock (luaEnv.luaEnvLock)
            {
		...
		public void __Gen_Delegate_Imp7(UnityEngine.EventSystems.PointerEventData p0)
		{
#if THREAD_SAFE || HOTFIX_ENABLE
            lock (luaEnv.luaEnvLock)
            {
		...
		public void __Gen_Delegate_Imp8(UnityEngine.EventSystems.BaseEventData p0)
		{
#if THREAD_SAFE || HOTFIX_ENABLE
            lock (luaEnv.luaEnvLock)
            {
		...
		public InvokeLua.ICalc __Gen_Delegate_Imp9(int p0, string[] p1)
		{
#if THREAD_SAFE || HOTFIX_ENABLE
            lock (luaEnv.luaEnvLock)
            {
		...
		public int __Gen_Delegate_Imp16(HotfixCalc p0, int p1, out double p2, ref string p3)
		{
#if THREAD_SAFE || HOTFIX_ENABLE
            lock (luaEnv.luaEnvLock)
            {
		...
		public double __Gen_Delegate_Imp17(double p0, double p1)
		{
#if THREAD_SAFE || HOTFIX_ENABLE
            lock (luaEnv.luaEnvLock)
            {
		...
		public int __Gen_Delegate_Imp19(int p0, string p1, out CSCallLua.DClass p2)
		{
#if THREAD_SAFE || HOTFIX_ENABLE
            lock (luaEnv.luaEnvLock)
            {
		...
		public string __Gen_Delegate_Imp27(object p0)
		{
#if THREAD_SAFE || HOTFIX_ENABLE
            lock (luaEnv.luaEnvLock)
            {
		...
		public UnityEngine.GameObject __Gen_Delegate_Imp28(StructTest p0, int p1, object p2)
		{
#if THREAD_SAFE || HOTFIX_ENABLE
            lock (luaEnv.luaEnvLock)
            {
		...
		public string __Gen_Delegate_Imp29(StructTest p0)
		{
#if THREAD_SAFE || HOTFIX_ENABLE
            lock (luaEnv.luaEnvLock)
            {
		...
		public void __Gen_Delegate_Imp32(object p0, object p1)
		{
#if THREAD_SAFE || HOTFIX_ENABLE
            lock (luaEnv.luaEnvLock)
            {
		...
		public int __Gen_Delegate_Imp33(object p0, object p1)
		{
#if THREAD_SAFE || HOTFIX_ENABLE
            lock (luaEnv.luaEnvLock)
            {
		...
		public override Delegate GetDelegateByType(Type type)
		{
			...
			{
			    return new System.Action<UnityEngine.Object>(__Gen_Delegate_Imp0);
			}
		    ...
		    if (type == typeof(System.Action<UnityEngine.Networking.UnityWebRequest>))
			{
			    return new System.Action<UnityEngine.Networking.UnityWebRequest>(__Gen_Delegate_Imp2);
			}
			...
			{
			    return new UnityEngine.Events.UnityAction<UnityEngine.EventSystems.PointerEventData>(__Gen_Delegate_Imp7);
			}
		
		    if (type == typeof(UnityEngine.Events.UnityAction<UnityEngine.EventSystems.BaseEventData>))
			{
			    return new UnityEngine.Events.UnityAction<UnityEngine.EventSystems.BaseEventData>(__Gen_Delegate_Imp8);
			}
		
		    if (type == typeof(InvokeLua.CalcNew))
			{
			    return new InvokeLua.CalcNew(__Gen_Delegate_Imp9);
			}
			...
			{
			    return new TestOutDelegate(__Gen_Delegate_Imp16);
			}
		
		    if (type == typeof(System.Func<double, double, double>))
			{
			    return new System.Func<double, double, double>(__Gen_Delegate_Imp17);
			}
			...
			{
			    return new CSCallLua.FDelegate(__Gen_Delegate_Imp19);
			}
		
		    if (type == typeof(CSCallLua.GetE))
			{
			    return new CSCallLua.GetE(__Gen_Delegate_Imp20);
			}
