...
namespace XLua
{
    public partial class DelegateBridge : DelegateBridgeBase
    {
		...
		public void __Gen_Delegate_Imp3(UnityEngine.Vector2 p0)
		{
#if THREAD_SAFE || HOTFIX_ENABLE
            lock (luaEnv.luaEnvLock)
            {
		...
		public void __Gen_Delegate_Imp4(UnityEngine.EventSystems.PointerEventData p0)
		{
#if THREAD_SAFE || HOTFIX_ENABLE
            lock (luaEnv.luaEnvLock)
            {
		...
		public void __Gen_Delegate_Imp5(UnityEngine.EventSystems.BaseEventData p0)
		{
#if THREAD_SAFE || HOTFIX_ENABLE
            lock (luaEnv.luaEnvLock)
            {
		...
		public double __Gen_Delegate_Imp13(double p0, double p1)
		{
#if THREAD_SAFE || HOTFIX_ENABLE
            lock (luaEnv.luaEnvLock)
            {
		...
		public override Delegate GetDelegateByType(Type type)
		{
			...
			{
			    return new UnityEngine.Events.UnityAction<string>(__Gen_Delegate_Imp2);
			}
			...
			{
			    return new UnityEngine.Events.UnityAction<UnityEngine.Vector2>(__Gen_Delegate_Imp3);
			}
		
		    if (type == typeof(UnityEngine.Events.UnityAction<UnityEngine.EventSystems.PointerEventData>))
			{
			    return new UnityEngine.Events.UnityAction<UnityEngine.EventSystems.PointerEventData>(__Gen_Delegate_Imp4);
			}
		
		    if (type == typeof(UnityEngine.Events.UnityAction<UnityEngine.EventSystems.BaseEventData>))
			{
			    return new UnityEngine.Events.UnityAction<UnityEngine.EventSystems.BaseEventData>(__Gen_Delegate_Imp5);
			}
			...
			{
			    return new System.Func<double, double, double>(__Gen_Delegate_Imp13);
			}
