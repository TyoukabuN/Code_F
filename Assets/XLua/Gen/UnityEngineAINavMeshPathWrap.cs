...
namespace XLua.CSObjectWrap
{
    ...
    public class UnityEngineAINavMeshPathWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			...
			System.Type type = typeof(UnityEngine.AI.NavMeshPath);
        ...
        static int _m_GetCornersNonAlloc(RealStatePtr L)
        {
		    try {
                ...
                {
                    UnityEngine.Vector3[] _results = (UnityEngine.Vector3[])translator.GetObject(L, 2, typeof(UnityEngine.Vector3[]));
                    
                        int gen_ret = gen_to_be_invoked.GetCornersNonAlloc( _results );
        ...
        static int _m_ClearCorners(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    ...
                    gen_to_be_invoked.ClearCorners(  );
        ...
        static int _g_get_corners(RealStatePtr L)
        {
		    try {
                ...
                UnityEngine.AI.NavMeshPath gen_to_be_invoked = (UnityEngine.AI.NavMeshPath)translator.FastGetCSObj(L, 1);
                translator.Push(L, gen_to_be_invoked.corners);
            } catch(System.Exception gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + gen_e);
            }
            return 1;
